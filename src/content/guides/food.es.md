---
title: "Dónde comer en Ilha Grande: las dos opciones honestas de un local"
description: "Dónde comer en Ilha Grande, por un anfitrión local: no un directorio de restaurantes, solo los dos lugares a los que de verdad te mandaría — uno amable con el bolsillo y otro para darse un gusto. Encontrá ambos en Google Maps."
lang: "es"
...
Este es el que recomiendo cuando alguien quiere una buena comida sin que pese en el bolsillo. Lo atienden sus dos dueños, y se nota: **comida brasileña casera** de verdad, de esa donde el *tempero* hecho en casa — el condimento — hace todo el trabajo. Es el **único lugar de la isla para una feijoada realmente buena**.
...
El menú se apoya en salmón en salsa de hierbas, pulpo, un muy buen filé mignon y pescado local. Algunas cosas que de verdad te diría que pruebes: la **salsa de maracuyá** (*molho de maracujá*), entradas como el gazpacho, y las guarniciones — rösti de papa y verduras grilladas, ambas excelentes. Para la calidad que tiene, no es tan caro, y comés realmente bien. Buscá **Dom Mário** en Google Maps.
