---
title: "How to Get to Ilha Grande (from Rio, São Paulo, Paraty & Mangaratiba)"
description: "The complete, up-to-date guide to reaching Vila do Abraão, Ilha Grande: every route from Rio de Janeiro, São Paulo, Paraty and Mangaratiba — boats, times, prices and local tips."
lang: "en"
...
faq:
  ...
  - q: "What is the easiest way to get to Ilha Grande from Rio?"
    a: "For most travellers, a shared transfer (a van for the road part plus a speedboat for the sea crossing) door-to-pier is the most comfortable option, taking roughly 3.5 to 4.5 hours from central Rio. The cheapest option is the Costa Verde bus to Angra or Conceição followed by a speedboat."
  - q: "Which mainland port should I leave from?"
    a: "Conceição de Jacareí has the shortest sea crossing (about 15 minutes by speedboat) and is the most practical from Rio. Angra dos Reis has the calmest, most sheltered waters and the most frequent boats. Mangaratiba is closest to Rio by road but usually has the roughest sea."
  - q: "Do I need to book the speedboats in advance?"
    a: "Usually no. Fast boats (Flex Boat type) run frequently throughout the day, so you buy a ticket at the pier. In high season (December to Carnival) it can get busy, so arriving earlier in the day is safer."
  - q: "What is the Taxa Viva Angra?"
    a: "It is an environmental access fee for visiting the Angra dos Reis / Ilha Grande area, paid online via a QR code before or on arrival. Keep the confirmation on your phone."
---
...
> 🧭 **Coming from abroad via Rio?** We have a separate guide with the traveller's verdict: the transfer trap on the way back, paying by Pix (and why there's no ATM on the island), and how many nights to stay → **[Rio de Janeiro to Ilha Grande](/rio-de-janeiro-to-ilha-grande/)**.

## Quick guide

If you're in a hurry, here's the short version by starting point:

| Coming from | Easiest route | Time | Rough cost (pp) |
|---|---|---|---|
| **Rio de Janeiro** | Shared van + speedboat transfer | ~3.5–4.5 h | ~R$200 |
| **Rio (budget)** | Costa Verde bus + speedboat | ~4–5 h | ~R$70–80 + ~R$100 |
| **São Paulo** | Bus to Angra dos Reis, then boat | ~7–9 h | varies |
| **Paraty** | Bus to Angra dos Reis, then boat | ~2.5–3 h | ~R$15–18 + boat |
| **Mangaratiba** | CCR ferry to Abraão | ~1h10–1h30 | ~R$20 (ferry) |

> Prices are approximate and change with the season — treat them as a guide, not a quote.

## Where are you coming from?

- [From Rio de Janeiro](#from-rio-de-janeiro) — the three ways
- [From São Paulo](#from-são-paulo)
- [From Paraty](#from-paraty)
- [From Mangaratiba](#from-mangaratiba)
...
### Option 1 — Shared transfer (van + speedboat) · recommended
...
| Port | Distance from Rio | Crossing to Abraão | Best for |
|---|---|---|---|
...
| **Mangaratiba** | closest by road | ~1h10–1h30 (ferry) | Drivers from Rio (rougher sea) |
