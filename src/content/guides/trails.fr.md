---
title: "Les sentiers d'Ilha Grande : les 5 plus belles randonnées (et le réseau T)"
description: "Le guide d'un local pour randonner à Ilha Grande : les cinq plus beaux sentiers balisés — Lopes Mendes, Dois Rios, Feiticeira, Pico do Papagaio et le Circuit Historique (T1) — avec distances, difficulté, sécurité et cartes."
lang: "fr"
...
faq:
  ...
  - q: "Faut-il un guide ?"
    a: "Pour la plupart des sentiers, non — ils sont bien balisés et se font seul. La grande exception est le Pico do Papagaio : la forêt y est dense et on s'y perd facilement, un guide local est donc vivement recommandé. Des randonneurs ont déjà dû y être secourus."
  - q: "Quel sentier choisir pour une première visite ?"
    a: "Lopes Mendes (pour la plage en récompense) et le Circuit Historique T1 (facile, riche en histoire) sont les deux meilleurs points de départ. Le Pico do Papagaio est réservé aux marcheurs entraînés et bien préparés."
  - q: "Comment les sentiers sont-ils balisés ?"
    a: "Ilha Grande possède un réseau de sentiers numérotés (les sentiers « T », de T1 à T16) entretenus dans le parc d'État. Par exemple, le Circuit Historique est le T1, Lopes Mendes suit le T10 + T11, le Pico do Papagaio est le T13 et Dois Rios le T14."
  - q: "À quelle heure partir ?"
    a: "Tôt. Partez avant 8h–10h selon le sentier : il fait plus frais, vous évitez la pluie de l'après-midi et vous avez le temps de rentrer avant la nuit. La forêt devient vite sombre et glissante."
---

Ilha Grande est avant tout une île de randonnée. Il n'y a pas de voitures — seulement un réseau de **sentiers forestiers balisés** (les sentiers numérotés « T », de T1 à T16) qui relient Vila do Abraão à des plages désertes, des cascades, des ruines du XIXe siècle et un sommet de 982 mètres. Presque toutes les marches partent à quelques minutes du quai d'Abraão, et elles sont toutes **gratuites**.

Voici les **cinq sentiers que je conseillerais à n'importe quel voyageur**, de la balade familiale facile à l'ascension sérieuse d'une journée entière. Pour la plupart, pas besoin de guide — juste de l'eau, de bonnes chaussures et un départ matinal. La seule vraie exception est le Pico do Papagaio, où un guide local est vivement recommandé.

## Les cinq sentiers en un coup d'œil
...
| **Circuit Historique** (T1) | ~1,8–3 km | 1–2 h | Facile–Modérée | Histoire, facile, en famille | [Wikiloc](https://pt.wikiloc.com/trilhas-trekking/abraao-x-praia-preta-x-ruinas-186822608) |

## Avant de partir : sécurité et équipement

Les sentiers sont superbes, mais cela reste de la vraie forêt tropicale — et l'île a quelques petites particularités qu'il vaut mieux connaître avant de se lancer. Rien de tout cela n'est là pour vous inquiéter : Ilha Grande est l'un des endroits les plus paisibles que je connaisse. Ce sont juste les choses que je dirais à un hôte autour du petit-déjeuner.

**Sur le sentier.**

- **Partez tôt** — avant 8h–10h. Vous évitez la chaleur, la pluie de l'après-midi et le risque de finir de nuit.
- **Emportez au moins 2 litres d'eau** par personne. La plupart des sentiers n'ont pas d'eau potable.
- **Portez de vraies chaussures de randonnée.** Après la pluie, le sol est glissant et il faut souvent s'agripper aux racines, branches et rochers — gardez les mains libres.
- **Vérifiez la météo** avant de partir et prévenez quelqu'un de votre itinéraire.
- **Respectez le balisage** et ne quittez pas le sentier — c'est ainsi qu'on se perd.

**Santé et bestioles.**

- **Prenez répulsif et crème solaire, et réappliquez les deux.** Les moustiques sont nombreux ici, mais la bonne nouvelle est plus importante : **aucune maladie endémique et aucune épidémie en cours** — les piqûres sont une gêne, pas un danger. La crème solaire compte parce que les plages ouvertes et les sommets ne vous offrent que très peu d'ombre.

**Argent.**

- **Aucun distributeur sur l'île** — et changer des devises ici se fait à mauvais taux, alors réglez vos retraits sur le continent avant la traversée.
- **Pas besoin de rationner votre monnaie pour le retour.** Le bateau qui ramène de Lopes Mendes, par exemple, **accepte la carte** — et s'il n'y a pas de réseau là-bas (en général il n'y en a pas), on vous embarque quand même et on vous débite à Abraão, où le signal passe très bien.
- **Fixez un plafond quotidien sur votre carte si vous le souhaitez** — jamais une mauvaise idée, partout au Brésil. À part ça, détendez-vous : l'île est extrêmement tranquille, sans arnaques, sans vols, sans agressions.
...
- **Achetez à l'intérieur d'une agence physique et signez sur place** — jamais à partir d'un numéro de téléphone glissé dans la rue. Si un arrangement de rue tourne mal, personne n'en répond : on vous promet un grand bateau et vous vous retrouvez dans un petit.
- **Demandez toujours quel type de bateau vous emmènera, et faites-le confirmer.** En règle générale : un bateau-taxi (ce sont tous des « CF », à la coque vive) convient pour un court trajet, mais pour une vraie excursion à la journée ou la **Volta à Ilha**, payez un peu plus pour une **lancha** plus grande et plus stable. Toute la différence est expliquée dans la section excursions en bateau du [guide des plages](/fr/plages-ilha-grande/).
...
> **L'essentiel en bref.** Sentier **T14** · **~7,2 km** dans chaque sens · environ **2h30 à l'aller** (~5 h aller-retour à pied) · altitude maximale d'à peine **235 m** · faisable **par tous les temps** · **aucun service sur le parcours** — emportez votre propre eau · **repartez de Dois Rios avant 15h30** pour la marche du retour.

**L'endroit que je recommande avant tous les autres sur l'île.** Vous franchissez la dernière crête et tout s'ouvre d'un coup sous vos pieds : une plage de plus d'un kilomètre, lovée au fond d'une baie profonde et abritée, presque toujours coiffée de sa propre bande de nuages bas — un caprice de la météo que, en toutes mes années ici, je n'ai jamais vu ailleurs qu'à Dois Rios. Deux rivières sombres, teintées de tanin et couleur cola (les habitants les appellent les « rivières Coca-Cola »), descendent de la forêt et rejoignent la mer juste là — deux embouchures, *deux rivières*, et voilà le nom. Éparpillé le long du sable, un minuscule hameau à moitié abandonné, où la Mata Atlântica et l'Atlantique avalent doucement le béton : maisons vides, murs fissurés, lianes qui passent par les fenêtres. Si vous avez joué à **Uncharted 4**, vous connaissez déjà cette sensation.

C'est aussi un lieu au passé hors du commun. **Une plantation de café, puis une vaste *fazenda*, puis l'une des prisons les plus tristement célèbres du Brésil** — et c'est l'un des très rares endroits au monde arraché à sa condition de prison (et à un projet de complexe touristique de masse) pour être, à la place, méticuleusement préservé. **La prison a été démolie en 1994 et transformée en musée.** Tout le site appartient à l'**UERJ**, l'Université d'État de Rio de Janeiro, si bien que personne ne peut s'y installer, y vivre ou y acheter un terrain — les quelques familles qui restent sont les héritières des anciens gardiens, qui veillent encore sur leur héritage. **On raconte qu'on avait autrefois lâché des caïmans dans les rivières** pour décourager les évasions par l'eau ; à la fin, dit-on, ce sont les gens qui ont fini par manger les caïmans. À votre arrivée, la police pénitentiaire encore postée ici procède à un discret contrôle. Très peu de voyageurs poussent jusqu'ici.

**Comment y aller.** Depuis Abraão, prenez l'**Estrada de Dois Rios** et continuez simplement tout droit — c'est toute la navigation. C'est une large piste de gravier taillée dans la montagne, construite à l'époque de la prison pour transporter le personnel et les détenus en camion et en minibus. Ne vous laissez pas effrayer par les avertissements ci-dessous : la piste est large et plutôt plate, culminant à seulement 235 m — rien d'escarpé, et tout marcheur en forme raisonnable peut le faire. Sur place, la cuisine est **caiçara** — les pêcheurs préparent ce qu'ils ont pêché ; vous mangez avec les deux rivières couleur cola qui se jettent dans la mer de part et d'autre et la jungle qui presse contre les maisons vides derrière vous.

> **Ce que personne ne vous dit : le retour.** À pied, Dois Rios, c'est une *vraie* journée — environ **2h30 dans chaque sens, soit à peu près 5 heures de marche** au total. Il n'y a **aucun bateau régulier pour rentrer à Abraão.** Il arrive qu'un bateau informel passe, mais c'est cher — autour de **150–200 R$ par personne** (avec de la chance, à plusieurs pour partager, peut-être ~100 R$). Et ce bateau nominal de **~16h30** n'est **pas garanti** : s'il ne réunit pas assez d'argent pour le carburant, il ne partira tout simplement pas, même avec deux personnes qui le supplient. Prévoyez donc de rentrer à pied, et **quittez Dois Rios à 15h30 au plus tard** — une heure avant le départ théorique du bateau — sinon la nuit vous rattrapera sur le sentier.
>
> **Une journée simple qui marche :** partez d'Abraão vers **8h00** → arrivée vers **10h30** → quelques heures sur la plage et au musée → repartez à **15h30** → de retour à Abraão vers **18h00**, en plein jour. Emportez assez d'eau et de nourriture pour toute la journée — nulle part où se ravitailler ni acheter en chemin.

📍 [Voir l'itinéraire complet sur Wikiloc](https://pt.wikiloc.com/trilhas-trekking/abraao-x-dois-rios-100261143)

### À éviter

- **Ne prenez pas « le raccourci ».** L'ancien sentier indigène court le long de la piste de gravier — environ 3,2 km de moins, et tentant pour ça — mais il n'est plus débroussaillé, donc envahi par la végétation et de fait impraticable. Restez sur la large piste et continuez tout droit.
- **Ne comptez pas sur un bateau pour rentrer.** Considérez tout retour en bateau comme un bonus, jamais comme votre plan (voir l'encadré du retour ci-dessus).
- **Ne traînez pas.** Repartez à pied avant 15h30 — plus tard et vous serez sur le sentier après la tombée de la nuit, sans aucun service et sans porte de sortie facile.

## Feiticeira

![La cascade Cachoeira da Feiticeira dans la forêt tropicale, Ilha Grande](../../assets/cachoeira-da-feiticeira-ilha-grande.jpg)

> **L'essentiel en bref.** Sentiers **T1 + T2** · **~3,9 km** jusqu’à la plage (**~5,4 km** pour le circuit complet des ruines) · **modérée** · altitude maximale d'à peine **~160 m** · jusqu'à la plage **avec le détour par la cascade : ~1h40–2h à l'aller** · retour **sans la cascade : ~1h20–1h40** · le bateau du retour est facile ici : **~35 R$ par personne** · reprenez **le retour avant 15h30** (en fin de journée la plage se remplit de la foule des tours en bateau) · emportez du **répulsif**, mettez de **bonnes chaussures**.
